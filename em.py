...
#
# gaus = GaussianMixture(random_state = 3) # sure
...
#
# for n in n_clusters:
#     gaus.set_params(n_components = n)
#     gaus.fit(x_wine)
#     labels = gaus.predict(x_wine)
#
...
#
#     plotx_acc.append(n)
#     ploty_acc.append(ami)
#
#     plot_dict[n] = silhouette_avg
#     plot_dict_ami[n] = ami
#     plot_dict_acc[n] = acc
#
# plt.title("EM / Gaussian Mixture")
# plt.subplot(211)
...
# #
# # plt.subplot(313)
# # plt.plot(plotx_acc,ploty_acc)
# # plt.xlabel('Number of Components')
# # plt.ylabel('Accuracy Score')
#
# plt.savefig("em_gaus_wine.png")
...
#     ami = adjusted_mutual_info_score(y_heart, labels)
#     acc = accuracy_score(y_heart, labels)
#     plotx.append(n)
#     ploty.append(silhouette_avg)
#
#     plotx_ami.append(n)
