...
class NeuralNetwork:
    ...
    def run_all_nn(self):
        ...
        self.run_nn(wine_data_pca, y_wine, "wine_pca")
        self.run_nn(heart_data_pca, y_heart, "heart_pca")
        self.run_nn(wine_data_ica, y_wine, "wine_ica")
        self.run_nn(heart_data_ica, y_heart, "heart_ica")
        self.run_nn(wine_data_rp, y_wine, "wine_rp")
        self.run_nn(heart_data_rp, y_heart, "heart_rp")
        self.run_nn(wine_data_lda, y_wine, "wine_lda")
        self.run_nn(heart_data_lda, y_heart, "heart_lda")
    ...
    def run_nn(self, x_data, y_data, title):
        ...
        # Create plot
        title_string = "Neural net learner for " + title
        plt.title(title_string)
        plt.xlabel("Training Set Size"), plt.ylabel("Accuracy Score"), plt.legend(loc="best")
        plt.tight_layout()
        plt.savefig("nn_" + title + ".png")
        plt.clf()
